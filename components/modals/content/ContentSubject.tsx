      ...
      {isLoading ? (
        ...
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            key={index}
            className={`cursor-pointer justify-center relative p-1.5 flex flex-col ${
              subject.id == subjectId && "bg-[#f0f1fc]"
            } rounded-[var(--radius-s)]`}
          >
            <span className="font-p-2 font-medium leading-normal">{subject.name}</span>
